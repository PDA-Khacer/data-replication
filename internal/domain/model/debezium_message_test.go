...
func TestMessage(t *testing.T) {
	Convey("Testing real message with updated = nil", t, func() {
		var debeziumMessage DebeziumMessage
		...
		var mockDebeziumValueMessage DebeziumValue
...
func TestDeleteMessage(t *testing.T) {
	Convey("Testing delete operator message", t, func() {
		var debeziumMessage DebeziumMessage
		mockRawKeyMessage := "{\n  \"schema\": {\n    \"type\": \"struct\",\n    \"fields\": [\n      {\n        \"type\": \"int64\",\n        \"optional\": false,\n        \"field\": \"employee_id\"\n      }\n    ],\n    \"optional\": false,\n    \"name\": \"employees_pg.employees.temp.Key\"\n  },\n  \"payload\": {\n    \"employee_id\": 2\n  }\n}"
		mockRawValueMessage := "{\n  \"schema\": {\n    \"type\": \"struct\",\n    \"fields\": [\n      {\n        \"type\": \"struct\",\n        \"fields\": [\n          {\n            \"type\": \"int64\",\n            \"optional\": false,\n            \"field\": \"employee_id\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": false,\n            \"field\": \"amount\"\n          },\n          {\n            \"type\": \"int32\",\n            \"optional\": false,\n            \"name\": \"io.debezium.time.Date\",\n            \"version\": 1,\n            \"field\": \"from_date\"\n          },\n          {\n            \"type\": \"int32\",\n            \"optional\": false,\n            \"name\": \"io.debezium.time.Date\",\n            \"version\": 1,\n            \"field\": \"to_date\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"name\": \"io.debezium.time.MicroTimestamp\",\n            \"version\": 1,\n            \"default\": 0,\n            \"field\": \"created_at\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"name\": \"io.debezium.time.MicroTimestamp\",\n            \"version\": 1,\n            \"field\": \"updated_at\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"name\": \"io.debezium.time.MicroTimestamp\",\n            \"version\": 1,\n            \"field\": \"deleted_at\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"name\": \"io.debezium.time.MicroTime\",\n            \"version\": 1,\n            \"field\": \"time_micro_test\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"name\": \"io.debezium.time.Timestamp\",\n            \"version\": 1,\n            \"field\": \"timestamp2_test\"\n          }\n        ],\n        \"optional\": true,\n        \"name\": \"employees_pg_temp.employees.temp.Value\",\n        \"field\": \"before\"\n      },\n      {\n        \"type\": \"struct\",\n        \"fields\": [\n          {\n            \"type\": \"int64\",\n            \"optional\": false,\n            \"field\": \"employee_id\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": false,\n            \"field\": \"amount\"\n          },\n          {\n            \"type\": \"int32\",\n            \"optional\": false,\n            \"name\": \"io.debezium.time.Date\",\n            \"version\": 1,\n            \"field\": \"from_date\"\n          },\n          {\n            \"type\": \"int32\",\n            \"optional\": false,\n            \"name\": \"io.debezium.time.Date\",\n            \"version\": 1,\n            \"field\": \"to_date\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"name\": \"io.debezium.time.MicroTimestamp\",\n            \"version\": 1,\n            \"default\": 0,\n            \"field\": \"created_at\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"name\": \"io.debezium.time.MicroTimestamp\",\n            \"version\": 1,\n            \"field\": \"updated_at\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"name\": \"io.debezium.time.MicroTimestamp\",\n            \"version\": 1,\n            \"field\": \"deleted_at\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"name\": \"io.debezium.time.MicroTime\",\n            \"version\": 1,\n            \"field\": \"time_micro_test\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"name\": \"io.debezium.time.Timestamp\",\n            \"version\": 1,\n            \"field\": \"timestamp2_test\"\n          }\n        ],\n        \"optional\": true,\n        \"name\": \"employees_pg_temp.employees.temp.Value\",\n        \"field\": \"after\"\n      },\n      {\n        \"type\": \"struct\",\n        \"fields\": [\n          {\n            \"type\": \"string\",\n            \"optional\": false,\n            \"field\": \"version\"\n          },\n          {\n            \"type\": \"string\",\n            \"optional\": false,\n            \"field\": \"connector\"\n          },\n          {\n            \"type\": \"string\",\n            \"optional\": false,\n            \"field\": \"name\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": false,\n            \"field\": \"ts_ms\"\n          },\n          {\n            \"type\": \"string\",\n            \"optional\": true,\n            \"name\": \"io.debezium.data.Enum\",\n            \"version\": 1,\n            \"parameters\": {\n              \"allowed\": \"true,last,false,incremental\"\n            },\n            \"default\": \"false\",\n            \"field\": \"snapshot\"\n          },\n          {\n            \"type\": \"string\",\n            \"optional\": false,\n            \"field\": \"db\"\n          },\n          {\n            \"type\": \"string\",\n            \"optional\": true,\n            \"field\": \"sequence\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"field\": \"ts_us\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"field\": \"ts_ns\"\n          },\n          {\n            \"type\": \"string\",\n            \"optional\": false,\n            \"field\": \"schema\"\n          },\n          {\n            \"type\": \"string\",\n            \"optional\": false,\n            \"field\": \"table\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"field\": \"txId\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"field\": \"lsn\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": true,\n            \"field\": \"xmin\"\n          }\n        ],\n        \"optional\": false,\n        \"name\": \"io.debezium.connector.postgresql.Source\",\n        \"field\": \"source\"\n      },\n      {\n        \"type\": \"struct\",\n        \"fields\": [\n          {\n            \"type\": \"string\",\n            \"optional\": false,\n            \"field\": \"id\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": false,\n            \"field\": \"total_order\"\n          },\n          {\n            \"type\": \"int64\",\n            \"optional\": false,\n            \"field\": \"data_collection_order\"\n          }\n        ],\n        \"optional\": true,\n        \"name\": \"event.block\",\n        \"version\": 1,\n        \"field\": \"transaction\"\n      },\n      {\n        \"type\": \"string\",\n        \"optional\": false,\n        \"field\": \"op\"\n      },\n      {\n        \"type\": \"int64\",\n        \"optional\": true,\n        \"field\": \"ts_ms\"\n      },\n      {\n        \"type\": \"int64\",\n        \"optional\": true,\n        \"field\": \"ts_us\"\n      },\n      {\n        \"type\": \"int64\",\n        \"optional\": true,\n        \"field\": \"ts_ns\"\n      }\n    ],\n    \"optional\": false,\n    \"name\": \"employees_pg_temp.employees.temp.Envelope\",\n    \"version\": 2\n  },\n  \"payload\": {\n    \"before\": {\n      \"employee_id\": 2,\n      \"amount\": 1,\n      \"from_date\": 6020,\n      \"to_date\": 6022,\n      \"created_at\": 1737534786280148,\n      \"updated_at\": null,\n      \"deleted_at\": null,\n      \"time_micro_test\": null,\n      \"timestamp2_test\": null\n    },\n    \"after\": null,\n    \"source\": {\n      \"version\": \"3.0.0.Final\",\n      \"connector\": \"postgresql\",\n      \"name\": \"employees_pg_temp\",\n      \"ts_ms\": 1737534800782,\n      \"snapshot\": \"false\",\n      \"db\": \"employees\",\n      \"sequence\": \"[\\\"280672784\\\",\\\"280672840\\\"]\",\n      \"ts_us\": 1737534800782810,\n      \"ts_ns\": 1737534800782810000,\n      \"schema\": \"employees\",\n      \"table\": \"temp\",\n      \"txId\": 629,\n      \"lsn\": 280672840,\n      \"xmin\": null\n    },\n    \"transaction\": null,\n    \"op\": \"d\",\n    \"ts_ms\": 1737534801045,\n    \"ts_us\": 1737534801045399,\n    \"ts_ns\": 1737534801045399478\n  }\n}"
		var mockDebeziumValueMessage DebeziumValue
		var mockDebeziumKeyMessage DebeziumKey
		err := json.Unmarshal([]byte(mockRawValueMessage), &mockDebeziumValueMessage)
		if err != nil {
		...
		fmt.Printf("result.ColWithKafka: %v\n", result.ColWithKafka)
		fmt.Printf("result.ColWithDebezium: %v\n", result.ColWithDebezium)
		fmt.Printf("result.ValPrimaryKey: %v\n", result.ValPrimaryKey)
		fmt.Printf("result.ValBefore: %v\n", result.ValBefore)
		tbPg := newPgTable(result)

		Convey("Test function GenQueryDeleteWithKeys", func() {
			//query := tbPg.GenQueryCreateTable()
			//query := tbPg.GenQueryInsertInto()
			//query := tbPg.GenQueryUpdate()
			query := tbPg.GenQueryDeleteWithKeys()

			fmt.Printf("query: %v\n", query)
		})

		Convey("Test function GenQueryDeleteExactlySingleNode", func() {
			//query := tbPg.GenQueryCreateTable()
			//query := tbPg.GenQueryInsertInto()
			//query := tbPg.GenQueryUpdate()
			query := tbPg.GenQueryDeleteExactlySingleNode()

			fmt.Printf("query: %v\n", query)
		})

		Convey("Test function GenQueryDeleteExactlyMultiNode case updated_at nil", func() {
			query := tbPg.GenQueryDeleteExactlyMultiNode()

			fmt.Printf("query: %v\n", query)
		})

		Convey("Test function GenQueryDeleteExactlyMultiNode case updated_at != nil", func() {
			result.ValBefore[constants.UpdatedAtField] = float64(1737429410784492)
			query := tbPg.GenQueryDeleteExactlyMultiNode()
